...
export default function PortfolioPage({params}) {
    ...
    const check = () => {
      ...
      if (verify) {
        return <Project name={verify.truename || verify.name} customimgclass={verify.customimgclass} projectN={verify.name} imgList={verify.imgList} description={verify.description} book={verify.book} right={verify.right} left={verify.left} />;
      } else {
        return (
