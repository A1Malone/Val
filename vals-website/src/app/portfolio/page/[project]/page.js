...
export default function PortfolioPage({params}) {
    ...
    const check = () => {
      ...
      if (verify) {
        return <Project name={verify.truename || verify.name} customimgclass={verify.customimgclass} projectN={verify.name} imgList={verify.imgList} description={verify.description} right={verify.right} left={verify.left} />;
      } else {
        return (
